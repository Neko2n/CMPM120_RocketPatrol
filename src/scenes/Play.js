class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // add spaceships (x3)
        this.ships = {
            one: new Spaceship(this, game.config.width + borderUISize*6, borderUISize*4, 'spaceship', 0, 30).setOrigin(0, 0),
            two: new Spaceship(this, game.config.width + borderUISize*3, borderUISize*5 + borderPadding*2, 'spaceship', 0, 20).setOrigin(0,0),
            three: new Spaceship(this, game.config.width, borderUISize*6 + borderPadding*4, 'spaceship', 0, 10).setOrigin(0,0)
        }
        // initialize score
        this.p1Score = 0
        // display score
